...
![How it looks](RedmineDownloader.jpg)

![How it looks](RedmineViewer.jpg)
...
you can: 
  ...
  * can drag&drop the individual issue.json, or the folder which includes it
### Flexible
...
* -x: Automatically starts the download process immediately after the software launches. The software will automatically exit once the download is complete.
